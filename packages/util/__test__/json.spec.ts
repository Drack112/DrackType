  ...
  describe("parseWithSchema", () => {
    ...
    it("should throw with invalid schema", () => {
      ...
      expect(() => parseWithSchema(json, schema)).toThrowError(
        `JSON does not match schema: "test" invalid input: expected boolean, received string, "name" invalid input: expected string, received undefined, "nested.foo" invalid input: expected string, received number`
      );
    });
    ...
    it("should throw if migration fails", () => {
      ...
      expect(() => {
        ...
        `Migrated value does not match schema: "test" invalid input: expected boolean, received string, "name" invalid input: expected string, received null`
      );
    });
